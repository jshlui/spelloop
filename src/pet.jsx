...
function PetSprite({ speciesId, completedChapters, mood, size, equipped, animate, reaction,
  ...
  var isShiny = false; // caller passes shiny via a wrapper if needed
  ...
  var stage = getPetStage(chapters, isShiny);
...
Object.assign(window, {
  ...
  getPetStage, getPetMoodLabel, getPetNextStage, getCompletedChapters,
  PET_MOOD_COLORS, STAGE_SVGS,
